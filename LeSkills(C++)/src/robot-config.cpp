...
motor PuncherMotorsMotorA = motor(PORT12, ratio36_1, false);
motor PuncherMotorsMotorB = motor(PORT13, ratio36_1, true);
motor_group PuncherMotors = motor_group(PuncherMotorsMotorA, PuncherMotorsMotorB);
